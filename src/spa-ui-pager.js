...
(function(exports) {
  ...
  function repaint(options) {
    ...
    _showA && (pagerHTML += a_1 + _getHref(1) + a_2 + _firstC + a_3 + 1 + a_4 + _firstT + a_5);
    if (c === 1) {
    ...
    if (total < 9) {
        ...
        if (c < 5) {
            if (c === 4) {
                ...
                pagerHTML += a_1 + _getHref(4) + a_2a3 + '4' + a_4 + '4' + a_5
                    + a_1 + _getHref(5) + a_23 + '5' + a_4 + '5' + a_5;
            } else {
                for (var i = 0; i < 4; ++i) {
                    if (c === i + 1) {
                        pagerHTML += a_1 + _getHref(i+1) + a_2a3 + (i+1) + a_4 + (i+1) + a_5;
            ...
            pagerHTML += HTML_SPAN
                + a_1 + _getHref(total-1) + a_23 + (total-1) + a_4 + (total-1) + a_5
                + a_1 + _getHref(total) + a_23 + total + a_4 + total + a_5;
        } else if (c > total - 4) {
            pagerHTML += a_1 + _getHref(1) + a_23 + '1' + a_4 + '1' + a_5
                + a_1 + _getHref(2) + a_23 + '2' + a_4 + '2' + a_5
                + HTML_SPAN;
            if (c === total - 3) {
                pagerHTML += a_1 + _getHref(c-1) + a_23 + (c-1) + a_4 + (c-1) + a_5
                    + a_1 + _getHref(c) + a_2a3 + c + a_4 + c + a_5;
                for (var i = 1; i < 4; ++i) {
                    if (c === total-3+i) {
    ...
    _showA && (pagerHTML += a_1 + _getHref(total) + a_2 + _lastC + a_3 + total + a_4 + _lastT + a_5);
  ...
  var Pager = exports.Pager = function(element, options) {
    ...
    wrapper.innerHTML = repaint(this.options);
  };
